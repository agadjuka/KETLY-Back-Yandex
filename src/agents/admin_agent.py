...
9. Англоязычная версия Ketly доступна по адресу https://ketly.pro/
...
3. После завершения демонстрации, уточни понравилась ли клиенту демонстрация, и предложи клиенту связать его с менеджером для обсуждения сотрудничества.

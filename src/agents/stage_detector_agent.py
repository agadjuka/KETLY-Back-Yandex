...
-клиент явно согласился на демонстрацию или сам ее попросил. (Он мог сделать это в предыдущих сообщениях, например "Я хочу посмотреть демонстрацию", либо просто ответил Да на предложение провести демонстрацию.
